        ...
        <div class="relative">
          ...
          <div class="relative z-10 bg-dark-light rounded-2xl shadow-card overflow-hidden backdrop-blur-sm border border-dark-lighter">
            ...
            <div class="bg-primary py-5 px-6">
              <h2 class="text-center text-2xl font-display font-bold text-white">Create Your Account</h2>
            </div>
            
            <!-- Form -->
            <form @submit.prevent="register" class="py-8 px-6 md:px-8">
              ...
              <div class="text-center text-sm mt-8">
                <p class="text-gray-400 mb-3">Already have an account?</p>
                <router-link to="/login" class="text-primary hover:text-red-400 font-semibold transition-colors duration-300">
                  Sign In
                </router-link>
              </div>
            </form>
